...
/**
 * Servlet implementation class SupervisorAjaxUserController
 */
@WebServlet("/searchUser.su")
public class SupervisorAjaxUserController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupervisorAjaxUserController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수 (db로부터 조회)
			listCount = new SupervisorService().selectSearchUserCount(value);
		}else{
			listCount = new SupervisorService().selectSearchUserCount2(value);
		}
		...
		List<Customer>	list = new SupervisorService().searchUserList(type,value,pi);
