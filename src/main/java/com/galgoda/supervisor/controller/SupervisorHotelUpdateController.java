...
/**
 * Servlet implementation class SupervisorHotelUpdateController
 */
@WebServlet("/hotelUpdate.su")
public class SupervisorHotelUpdateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupervisorHotelUpdateController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int result =  new HotelService().updateHotel(h, list);
