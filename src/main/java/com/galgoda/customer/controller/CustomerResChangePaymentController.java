...
/**
 * Servlet implementation class CustomerResChangePaymentController
 */
@WebServlet("/resPayChangeAmount.cu")
public class CustomerResChangePaymentController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerResChangePaymentController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.getRequestDispatcher("/views/customer/resChangePayForm.jsp").forward(request, response);
	}
