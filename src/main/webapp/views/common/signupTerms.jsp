                ...
                <div class="tos_form">
                    ...
                    <div class="terms_of_use">
                        ...
                        <div class="terms_content">
                            ...
                            <p>1. 회원 가입은 홈페이지에서 가능합니다.</p>
                            <p>2. 회원 가입은 무료입니다.</p>
                            <p>3. 회원은 하나를 초과하는 멤버십에 가입하거나 소유할 수 없습니다.</p>
                            <p>4. 멤버십 중복 가입 시 하나를 제외한 멤버십은 강제 탈퇴 처리됩니다.</p>
                            <p>5. 회원 등록 시 성명, 생년월일, 성별, 전자우편주소, 전화번호는 필수 기입 사항입니다.</p>
                            <p>6. 회원번호는 회원 등록 즉시 발급됩니다.</p>
                            <p>7. 회원은 회원번호를 이용하여 홈페이지에서 본인의 계정을 확인할 수 있습니다.</p>
                        </div>
                    </div>
