                	...
                	<form action="<%=contextPath %>/updateTerm.su" method="post" enctype="multipart/form-data">
	                    ...
	                    <table align="center">
	                        <tr>
	                            <th>제목</th>
	                            <td colspan="2">
	                                <input type="text" class="formCustume" name="title" style="width: 100%; text-align: center;" value="<%=t.getTermsTitle() %>" >
	                            </td>
	                        </tr>
	                        <tr>
	                        ...
	                        <tr>
	                            <td colspan="3" style="margin-top: 20px;">
	                                <textarea name="content" class="textareaCustume" rows="20"  style="resize: none; width: 100%;" ><%=t.getTermsContent() %></textarea>
	                            </td>
	                        </tr>
	                        <tr>
	                            <th>첨부파일</th> 
	                        ...
	                        <tr>
	                            <th>비고</th> 
	                            <td colspan="2">
	                            	<input type="text" class="form-control" name="notes" value="<%=t.getNotes()%>">
	                            </td>
	                        ...
	                        <tr>
	                            <td colspan="3" align="right">
	                                <button  class="btn" style="background-color: rgb(115, 90, 75); color: white;">수정하기</button>
