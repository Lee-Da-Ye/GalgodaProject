                    ...
                    <table class="table">
                        <tbody>
							...
							<tr>
								...
								<td style="width: 85%;"><p class="faq_question"><%= list.get(i).getFaqContent() %></p></td>
								<td style="width: 10%;" align="right"><a href="#faq<%= i %>"
									data-toggle="collapse"> <img
										src="resources/images/bottom.png" style="margin-top: 10px;">
								</a></td>
							</tr>
							<tr>
								<td colspan="3" class="collapse" id="faq<%= i %>" data-parent="#bbb"
									style="background-color: rgb(253, 251, 249);">
