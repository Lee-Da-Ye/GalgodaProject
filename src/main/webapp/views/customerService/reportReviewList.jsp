	...
	<div class="wrap">
        ...
        <section class="main_content">
            ...
            <div class="page_content">
                <h2 class="contentName">신고 리뷰 관리</h2>
                ...
                <ul class="pagination" style="margin-top: 50px; width: 95%; justify-content: center;">
                    ...
                    <% }else { %>
                    <li class="page-item">
                    	<a class="page-link" href="<%= contextPath %>/reviewList.rep?page=<%= pi.getCurrentPage() - 1 %>">&lt;</a>
                    </li>
                 	<% } %>
                 	<% for(int p=pi.getStartPage(); p<=pi.getEndPage(); p++){ %>   
	                    ...
	                    <% }else { %>
	                    <li class="page-item">
	                    	<a class="page-link" href="<%= contextPath %>/reviewList.rep?page=<%= p %>"><%= p %></a>
	                   	</li>
                 		<% } %>
                 	<% } %>
