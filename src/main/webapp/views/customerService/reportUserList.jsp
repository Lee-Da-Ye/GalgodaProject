        ...
        <section class="main_content">
            ...
            <div class="page_content">
                ...
                <ul class="pagination" style="margin-top: 50px; width: 95%; justify-content: center;">
                    ...
                    <% }else { %>
                    <li class="page-item"><a class="page-link" href="<%= contextPath %>/userList.rep?page=<%= pi.getCurrentPage() - 1 %>">&lt;</a></li>
                 	<% } %>
                 	<% for(int p=pi.getStartPage(); p<=pi.getEndPage(); p++){ %>   
                    	<% if(p == pi.getCurrentPage()){ %>
	                    <li class="page-item active"><a class="page-link" href="#"><%= p %></a></li>
	                    <% }else { %>
	                    <li class="page-item"><a class="page-link" href="<%= contextPath %>/userList.rep?page=<%= p %>"><%= p %></a></li>
                 		<% } %>
                 	<% } %>
