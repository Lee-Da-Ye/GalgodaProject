                               ...
                               <!--  페이징바 영역 -->
					                <ul class="pagination justify-content-center">
					                    ...
					                    <li class="page-item disabled"><a class="page-link" href="#"> &lt; </a></li>
					                 	<% } else { %>
					                    <li class="page-item"><a class="page-link" href="<%= contextPath %>/resList.ho?page=<%=pi.getCurrentPage()-1%>"> &lt; </a></li>
					                    <% } %>
					                    ...
					                    <% for(int p= pi.getStartPage(); p<=pi.getEndPage(); p++){ %>
						                    ...
						                    <% } else{ %>
						                    <li class="page-item"><a class="page-link" href="<%= contextPath %>/resList.ho?page=<%= p %>"> <%= p %></a></li>
						                    <% }  %>
					                    <% } %>
