...
<style>
  /* 메인컨텐츠  */
        ...
        #btnconfirm {background-color: #EBE7E3; font-size: 15px; border: 1px solid #D4D4D4 ; width: 85px; height: 40px; padding: 7px;  }
         ...
         .form_controller input {width: 100%;}
         .add_content { 
        ...
        <section class="main_content">
            ...
            <div class="sideMenubar">
                <ul class="nav flex-column">
                    ...
                    <li style="background-color: #BFB4B0;"> <div id="demo" class="collapse show" style="margin-left: 30px;"><a href="<%= contextPath%>/roominsertForm.ho">객실등록</a></div> </li>  
            ...
            <div class="page_content" style="margin-bottom: 150px;">
                ...
                <span id="title1">호텔관리</span> <span id="title2"> - 객실등록</span>
                ...
                <span id="title3">호텔정보</span>
                    <form action="<%= contextPath %>/roominsert.ho" method="post"  onsubmit=" insertRoom();" enctype="multipart/form-data">
                        
                        <table class="table2">
                        	<input type="hidden" name="hotelNo" value="<%= h.getHotelNo()%>">
                            <tr>
                                <td id="td1"><button class="btn  " id="btnname" type="button"  >객실명</button></td>
                                <td id="td2"><input type="text" class="form-control" required  name="roomName"></td>
                            </tr>
                            </table>
                            <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id="td3"><input type="number" class="form-control sminput"   min="0" name="roPeople" value="2" required> 명</td> 
                            </tr>
                            <tr>
                                <td id="td1"><button class="btn " id="btnname" type="button" >욕실 수</button></td>
                                <td id="td3"><input type="number" class="form-control sminput"   min="0" max="5" name="roBath" value="1" required></td> 
                            </tr>
                            <tr>
                                <td id="td1"><button class="btn  " id="btnname" type="button" >가격</button></td>
                                <td id="td3"><input type="text" class="form-control sminput" name="roPrice" placeholder="숫자만 입력" required> 원</td> 
                            </tr>
                            <tr>
                                <td id="td1"><button class="btn  " id="btnname" type="button" >최대수량</button></td>
                                <td id="td3"><input type="number" class="form-control sminput"   min="0" name="roCount" value="5" required> </td> 
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td  colspan="2" align="right"  id="td1">
                                    ...
                                    <button class="btn " id="btnconfirm" type="submit" >등록하기</button>
                                </td>
                            </tr>
                        </table>
