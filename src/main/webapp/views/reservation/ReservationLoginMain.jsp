...
<%
	Reservation loginRes = (Reservation)request.getAttribute("loginRes");
...
<head>
<meta charset="UTF-8">
<title>Reservation LoginMain</title>
                    ...
                    <div class="container">
                        <div class="d-flex justify-content-center h-100">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="loginForm" action="<%=contextPath %>/login.res" method="post">
										...
										<input type="hidden" name="hotelNo" value="<%=loginRes.getHotelNo() %>">
										<input type="hidden" name="hotelName" value="<%=loginRes.getHotelName() %>">
										<input type="hidden" name="checkInDate" value="<%=loginRes.getDateIn()%>">
										<input type="hidden" name="checkOutDate" value="<%=loginRes.getDateOut()%>">
